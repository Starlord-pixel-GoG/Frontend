...
const API_BASE_URL = 'https://backend-d81p.onrender.com/api'; // Para producción 
...
//• API_BASE_URL: La dirección donde está tu servidor
//• currentUser: Guarda información del usuario actual

//  2. Event Listeners:
//• addEventListener: Escucha eventos (como hacer clic o enviar formularios)
//• DOMContentLoaded: Se ejecuta cuando la página termina de cargar

//  3. Funciones async/await:
//• async: Indica que la función puede esperar respuestas
//• await: Espera a que termine una operación (como una petición al servidor)
//• fetch: Envía peticiones HTTP al servidor

//  4. localStorage:
//• Guarda información en el navegador del usuario
